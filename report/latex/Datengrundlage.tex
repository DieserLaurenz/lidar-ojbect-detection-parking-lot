...
\caption[Grundriss des Versuchsbereichs mit Sensorpositionen]{Grundriss des Versuchsbereichs in der Tiefgarage des Fraunhofer FOKUS mit den Sensorpositionen OS0 und OS1 entlang der markierten Route. Aus \cite[Abb.~21]{pagel2025railway}.}
\label{fig:setup}
\end{figure}
...
\caption[Manuelle Nachbearbeitung der Annotationen]{Manuelle Nachbearbeitung der Ground-Truth-Annotationen mit dem projektspezifischen Bounding-Box-Editor. Dargestellt ist eine Punktwolke mit orientierten 3D-Boxen für die Klassen Person, Fahrrad und Auto.}
