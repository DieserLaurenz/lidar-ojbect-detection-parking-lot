...
# the merged *train* split only, to counter the class imbalance
...
val_evaluator = dict(
    pklfile_prefix='results/exp/merged_gtsample_val_results',
    result_prefix='results/exp/merged_gtsample_val_metric',
)
test_evaluator = dict(
    pklfile_prefix='results/exp/merged_gtsample_test_results',
    result_prefix='results/exp/merged_gtsample_test_metric',
)
